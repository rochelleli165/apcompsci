...
public class User {
  ...
  public User(String username, String password) throws IllegalArgumentException, DuplicateRequestException {
    ...
    if(usernameList.contains(username)){
      throw new DuplicateRequestException("username already in use");
    }
    if(password == null || password.isBlank())
    {
      throw new IllegalArgumentException("Null or blank password");
    }
  ...
  public String toString() {
    ...
    int numStars = password.length();
    // Hint: the String method "*".repeat(8) will return the string "********" (8 stars)
    
    return username + ": " + "*".repeat(numStars); // default return statement added to avoid compiler errors. Feel free to change it.
  }
...
class ForumUser extends User{ // TODO: 9. Set this class to be a subclass of the User class
  ...
  public void makePost(String password, String postText) {
    ...
    {
      System.out.print("Sorry, you are not allowed to post.");
    }
  }
  ...
  public String toString() {
    ...
    return super.toString() + " " + numPosts; // default return statement added to avoid compiler errors. Feel free to change it.
  }
